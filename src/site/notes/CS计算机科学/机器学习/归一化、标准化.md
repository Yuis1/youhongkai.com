---
{"dg-publish":true,"permalink":"/CS计算机科学/机器学习/归一化、标准化/","created":"2024-04-17T15:17:32.000+08:00","updated":"2024-04-24T00:24:21.000+08:00"}
---
...
![](http://upload-images.jianshu.io/upload_images/4002182-cf62bface7a1a51e.jpg)

原始数据

①z-score 归一化：缩放到均值为 0，方差为 1（Standardization—**StandardScaler()**）。常翻译为标准化  

![](http://upload-images.jianshu.io/upload_images/4002182-b96c61b13b6e8917.jpg)

处理后

②min-max 归一化：缩放到 0 和 1 之间（Standardization——**MinMaxScaler()**）。常翻译为归一化  

![](http://upload-images.jianshu.io/upload_images/4002182-90e5bb0277cb7db0.jpg)

处理后

③缩放到 - 1 和 1 之间（Standardization——**MaxAbsScaler()**）  

![](http://upload-images.jianshu.io/upload_images/4002182-05e29f5bca784e49.jpg)

处理后

④缩放到 0 和 1 之间，保留原始数据的分布（Normalization——**Normalizer()**）  

![](http://upload-images.jianshu.io/upload_images/4002182-c121bb825e6e3b25.jpg)
...
![](http://upload-images.jianshu.io/upload_images/4002182-9d399e002246a85f.png)
...
![](http://upload-images.jianshu.io/upload_images/4002182-82b0e6e11c2ee60e.png)
